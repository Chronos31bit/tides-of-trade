...
function HarborVisualService:KnitStart()
	...
	HarborService.BuildingPlacedServer.Event:Connect(function(owner: Player, building: any)
	...
	HarborService.BuildingUpgradedServer.Event:Connect(function(owner: Player, building: any, oldTier: number, newTier: number)
		local origin = HarborService:GetPlotOrigin(owner); if not origin then return end
